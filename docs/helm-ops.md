...
* polling is supported: Fleet can check available OCI tags matching the repository and provided version constraint on a
regular basis, configured through the polling interval.
